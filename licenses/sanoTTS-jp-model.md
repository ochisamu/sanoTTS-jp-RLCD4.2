...
既知の制約は [`MODEL_CARD.md`](sanoTTS-jp-model-card.md) を参照してください。
...
（[`docs/decisions.md`](../third_party/sanoTTS-jp/docs/decisions.md) D-035）。
...
artifact, not a production-quality model. See [`MODEL_CARD.md`](sanoTTS-jp-model-card.md).
